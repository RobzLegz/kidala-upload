        ...
        <div className="bg-primary-800 w-full h-full flex items-center justify-center group relative rounded-lg overflow-hidden border border-primary-700">
            <div className="w-[250px] md:w-[400px] h-[200px] sm:h-[300px] max-w-full max-h-full relative">
                <Image
                    ...
                    layout="fill"
                    quality={65}
                    blurDataURL={`${BASE_URL}/${props.hash}`}
                    placeholder="blur"
            ...
            <div className="flex h-10 w-full items-center justify-between absolute backdrop-blur-md bottom-0 rounded-b-lg z-10 transition-all duration-300 px-2 bg-transparent_dark translate-y-full group-hover:translate-y-0">
